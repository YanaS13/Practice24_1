...
public class ClientRepository {
    ...
    public long save(Client client) {
        final String insertSql = "INSERT INTO products (name_clients, username,password,email,basket_id) VALUES (?,?,?,?,?);";
            ...
            preparedStatement.setInt(5, basketService.creatBasket());
    ...
    private static RowMapper<Client> getProductRowMapper() {
        return (resultSet, rowNum) -> {
            ...
            return new Client(id, name, login, password, email, basket);
        };
    }
}
